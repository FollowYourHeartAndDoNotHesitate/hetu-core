...
public class ScalarImplementationChoice {
    ...
    public static class ArgumentProperty
    {
        ...
        public static ArgumentProperty valueTypeArgumentProperty(InvocationConvention.InvocationArgumentConvention argumentConvention)
        {
